...
[ -e $NOTEBOOK_PEM_FILE ] || ( openssl req -new -newkey rsa:2048 -days 356 -nodes -x509 -subj "/C=XX/ST=XX/L=XX/O=generated/CN=generated" \
  -keyout $NOTEBOOK_PEM_FILE -out $NOTEBOOK_PEM_FILE && chmod 600 $NOTEBOOK_PEM_FILE )
